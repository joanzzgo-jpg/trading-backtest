...
(function initPeekBear() {
  ...
  const LINES = [
    // ── 日常短打 ──
    "我說我要早睡。然後我滑手機滑到三點。",
    "我設了六個鬧鐘。我關掉六個。繼續睡。鬧鐘是心理安慰。",
    "我說要少吃。然後我說這塊算零食，不算正餐。吃了四塊。",
    "我說這週要認真。週一這樣說。週五我想起來了。",
    "我買了健身房會員。我去了一次。那次是參觀。",
    "我說要存錢。然後我說這個東西打折，不買才虧。買了。",
    "我媽問我有沒有在吃早餐。我說有。下午兩點。",
    "我說要整理房間。我整理了桌面。把東西堆到床上。房間更亂了。",
    "我說不要再買衣服。我說這件是必需品。我買了。我有十三件必需品。",
    "我計畫了很久的旅遊。查了機票。沒買。繼續查。查了兩年了。",
    "我說我不看劇。我說看一集就好。八集後我說再一集。",
    "我睡前說明天要早起。我關掉鬧鐘的速度非常快。快到我以為自己沒睡。",
    "我說我在節食。然後我說今天是特別的日子。每天都是特別的日子。",
    "我問朋友要不要出去玩。他說好啊什麼時候。我說再說。說了三年了。",
    "我說我要開始運動。我找了很多影片。收藏了。沒看。",
    "我說今天要有效率。我整理了待辦清單。清單整理完了。效率結束了。",
    "我說我不依賴咖啡。早上沒喝，頭痛。那不是依賴，那是缺乏。",
    "我說要少滑手機。我下載了計時APP。計時APP也是手機。",
    "我說今天心情不好，不想說話。我說了一個小時。",
    "我說要減肥。然後我說今天是最後一天吃這個。說了兩個月了。",
    "我說好久沒聯絡老朋友了，要找他們。我想了一下。繼續滑了。",
    "我說要學一個新技能。我買了課程。那個課程現在在購物車旁邊的收藏清單裡。",
    "我說這次絕對不遲到。我提早出門了。然後在便利商店待了二十分鐘。",
    "我說要認真寫計畫。我打開筆記本。畫了一條線。換顏色了。",
    "我說只是逛逛不買。我回家的時候有三個袋子。",
    // ── 日常對話 ──
    "「你在幹嘛？」\n「沒什麼。」\n「你在滑什麼？」\n「沒什麼。」\n「你看了多久了？」\n「不知道。」\n「兩個小時了。」\n「……沒有那麼久。」",
    "「你早餐吃了嗎？」\n「吃了。」\n「吃什麼？」\n「餅乾。」\n「那不算早餐。」\n「我覺得算。」",
    "「你說要早睡。」\n「對。」\n「現在幾點？」\n「……不重要。」",
