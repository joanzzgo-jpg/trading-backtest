...
(function initPeekBear() {
  ...
  const LINES = [
    // ── 博恩風格：邏輯自洽的荒謬，punchline 重新定義前面所有鋪陳 ──
    "我花一年學技術分析，學會看型態。後來發現型態是給散戶看的，主力不用看，因為是他們畫的。",
    "我設止損在 -8%。它跌到 -7.9%，我說撐住，快到了。它跌到 -8.1%。我的紀律非常精準。",
    "他說長期持有一定賺。我問多長期。他說五到十年。我問如果跌五到十年呢。他說那就更長期。我現在在做超長期投資。",
    "我媽叫我不要炒股，要做投資。我投資了。我現在理解她說的其實是同一件事。",
    "我看大師的書，學會逆向思維。大家買我賣，大家賣我買。我破產了，但思維很逆向。",
    "我問老師這支能不能買。他說可以。我買了賠了。我問他怎麼看錯。他說那是你的功課。我付了學費，他出了功課。",
    "交易最難的是控制貪婪。我有控制——我的貪婪現在只在每次進場前的三秒鐘出現。",
    "他們說做空風險無限。我做多，風險有限，限於我所有的錢。我覺得這樣比較安全。",
    "我做了六個月的回測，系統勝率 78%。實盤三個月，虧了 40%。我發現差別在於：歷史不會緊張。",
    "他們說要獨立思考，不要跟風。我不跟風，我自己研究。研究完，跟風的已經出場了，我剛進去。",
    // ── Jim 陳建平風格：老師口吻，說完讓你啞口無言 ──
    "你說停損砍了很痛。你知道什麼更痛嗎？不砍。",
    "便宜了 30%，你說可以買了。它又跌 30%。你買的不是便宜，你買的是方向。",
    "外資連三買，你跟進去了。外資今天連三賣。你現在知道外資為什麼能連三買了嗎？",
    "你問主力會不會護盤。你在問這個問題的時候，他已經跑了。",
    "你說基本面好，可以長抱。沒問題，只要你比主力抱得久。主力昨天賣了。",
    "你看，它在這裡打了三次底，你說要反彈了。第四次下去，就沒有底了。",
    "你說這個位置支撐很強。我說，支撐是用來跌破的，不然要它幹嘛。",
    "你問我這支到底了沒。我說不知道。你說你是老師應該要知道。我說老師也不是主力，你去問主力。",
    "你說你不追高，你等回檔買。它回檔了，你說還會跌，再等。它漲回去了。你等到了什麼？",
    "消息出來說要漲。消息都出來了，代表主力要賣了。你是來接的。",
  ];
  let _lineIdx = 0;
