...
(function initPeekBear() {
  ...
  const LINES = [
    ...
    "有人說做空是在做空台灣。我做空賠了錢。所以我是在支持台灣。",
    "我每次都說這是最後一筆。我說了四十七次了。",
    "別人笑我看不開，我看開了——帳戶歸零，反而心很平靜。",
    "我媽問我投資賺了多少。我說：媽，我學到了很多。",
    "他們說高風險高報酬。我高風險了。報酬還在路上。",
    "我加倉的邏輯是：跌這麼多了，不可能再跌了。他可以的。",
    "群組裡都說這個幣要爆漲。我進場了。它爆了，但方向不對。",
    "技術分析說要突破頸線買進。我買了。它用頸線把我勒住了。",
    // Jim 陳建平風格
    "你看，主力就是這樣，先把你洗出去，再拉給別人看。",
    "散戶永遠在最高點買，最低點賣。這不是巧合，這是天賦。",
    "你問我現在能不能買？我問你，你停損設好了嗎？沒有？那不能買。",
    "主力進貨的時候，散戶說這支沒希望了。主力出貨的時候，散戶說這支要飆了。",
    "你看這個量，縮量下跌，代表什麼？代表還會再跌。",
    "不要猜頭猜底，猜死你為止。",
    "這波跌下來，很多人說要攤平。攤平是把小虧變大虧的專業技術。",
    "他說這是支撐。我說，支撐是用來跌破的。",
    "法人買超，你就跟著買？法人也會凹單，只是他們凹得起。",
    "你看到紅K就興奮，看到黑K就絕望。主力就是靠這個賺你的錢。",
    "做波段最重要的是紀律。大部分人的紀律就是沒有紀律。",
    "跌停了還在問要不要賣？早幹嘛去了。",
  ];
  let _lineIdx = 0;
