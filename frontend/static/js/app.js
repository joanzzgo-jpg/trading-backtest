...
(function initPeekBear() {
  ...
  const LINES = [
    ...
    "他們說分散風險。我分散了。每個都跌。",
    "虧損讓人成長。我已經很成熟了。",
    "他們說高風險高報酬。我只拿到高風險那半句。",
    "我買在最高點。這需要天分的。",
    "我說我在存股。買進那天開始跌。我存了很久了。",
    "我學了一年技術分析。結論是運氣比較重要。",
    "別人恐懼我貪婪。結果那天我也恐懼了。",
    "我媽叫我不要炒股。我說我在投資。是一樣的事。",
    "我設了止損。但我移掉了。",
    "加倉的理由是：跌這麼多了不可能再跌。它可以的。",
    "我說我有交易系統。系統說買。我買了。系統沒說它也會錯。",
    "我做了功課才進場。功課沒做錯，是市場做錯了。",
    "他說要在別人貪婪時恐懼。我恐懼了。別人繼續賺。",
    "我說這次不一樣。上次我也說不一樣。",
    "我告訴自己不追高。它漲了30%我進去了。",
    "我只做現貨，不碰槓桿。現貨也可以歸零，只是比較慢。",
    "我說我理性分析。其實是找理由讓自己買。",
    "我說我不貪心，賺10%就跑。漲到8%我想再等等。它跌回來了。",
    "我出場了，它漲了。我進場了，它跌了。市場認識我。",
    "我說我不在乎短期波動。跌30%的時候，我很在乎。",
    "朋友說靠這個買房了。我靠這個把房子拿去抵押了。",
    "我訂了三個付費群組。他們叫我買三個不同的東西。都跌了。",
    "我每次虧錢都說要檢討。我檢討了很多次，虧法越來越多元。",
    "我說我有耐心。等了六個月。它跌更多了。我的耐心很夠用。",
    "我說要順勢。勢在哪裡我找了很久。找到的時候它已經結束了。",
    "我說我有自己的想法，不跟風。我的想法每次都比風晚一步。",
    "我說做空賺差價。它一直漲。差價是我的血。",
    "群組說今晚要爆拉。我設好鬧鐘等著。它跌了。鬧鐘還響。",
    "我說這次要嚴守紀律。我嚴守到第二根K線。",
    "我問老師這支能不能買。他說看個人。這個答案要收費三千。",
    "我的帳戶績效是負的。我說我在學習。學費很貴。",
    "他說看長不看短。短期先虧死我了。",
    "我說我不會再衝動了。我想了五秒鐘。然後下單了。",
    // ── Jim 陳建平 ──
    "你說停損砍了很痛。不砍更痛。",
    "支撐是用來跌破的。",
    "消息出來才買，主力早跑了。",
    "攤平是把小虧變大虧的專業技術。",
    "不要猜頭猜底，猜死你為止。",
    "外資連買三天你跟進去，他今天賣。你現在知道他為什麼買得起了。",
    "你說基本面好可以長抱。主力昨天賣了。你繼續抱。",
    "便宜了30%可以買。它又跌30%。你買的是方向，不是便宜。",
    "你問主力會不會護盤。你在問的時候他已經跑了。",
    "量縮下跌，代表沒人接。你進去接，你就是那個沒人。",
    "跌停了還在問要不要賣。你已經沒得選了。",
    "你說散戶能贏。可以，只要你不像散戶。",
    "你說這次打底了。底是打了，但往下打。",
    "主力拉高出貨，你以為是突破。你幫他出貨了。",
    "你問我為什麼跌。我說主力要賣。你問為什麼要賣。我說因為你要買。",
    "你說這個型態很漂亮。漂亮的型態騙最多人。",
    "好消息出來要賣，壞消息出來要買。你記住了，但你做不到。",
    "你說上次被洗出去可惜，這次要撐住。撐住就是凹單。",
    "你說你做技術分析。主力今天改走法了，你的圖沒更新。",
    "你說外資買超代表看好。外資看好的，不一定是現在。",
    "你看這個成交量，騙線量，你買了嗎？買了。你貢獻了。",
    "你問我這支能不能買。你止損設哪裡？沒設？那不能買。",
    "你說跌深反彈。跌深可以更深。",
    "你說法說會後要漲。法說會前主力已經拉了。你來得晚。",
    "做對方向只是開始。拿得住才算。你拿得住嗎？",
    // ── 蔡冠雙頭 漫才 ──
    "「我找到必勝法了！」\n「哦，什麼法？」\n「跌了不賣。」\n「那是套牢，不是必勝。」",
    "「我今天賺錢了！」\n「賺多少？」\n「手續費還沒扣。」",
    "「我這次不會衝動！」\n「然後呢？」\n「我想了五秒。然後下單了。」",
