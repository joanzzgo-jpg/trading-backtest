...
(function initPeekBear() {
  ...
  const LINES = [
    // ── 短打 ──
    "我追漲它跌，我停損它漲，我觀望它噴。我是指標。",
    "我說我在投資。我媽說那和賭博有什麼不一樣。我想了很久。",
    "我刪掉交易APP。然後重新下載。刪掉。下載。刪掉。下載。我在健身。",
    "我跌50%，朋友說你要停損了。我說那就真的虧了。他看著我，沒再說話。",
    "我買了，它跌。我賣了，它漲。我看著它，它不動。我是詛咒。",
    "我設了止盈，漲到目標我捨不得，移掉了。現在虧60%。止盈是用來移掉的。",
    "我說這次只放閒錢。然後我把閒錢的定義改了一下。",
    "群組說要噴。我進去了。它噴了——往下噴。",
    "我買了三本技術分析書。現在用來墊螢幕，角度剛好。",
    "他們說市場會回歸均值。我的虧損也回歸了。回歸到更低的均值。",
    "我說我不FOMO。它漲20%我忍住。漲40%忍住。漲60%我買了。跌了。",
    "我問AI這支會不會漲。它說有漲有跌。收費三千。",
    "我學了一年技術分析。我現在能精準預測——昨天的走勢。",
    "我女友說我們去旅遊。我說帳戶回本就去。她去年一個人去了。",
    "「長期投資」是我虧太多不敢賣之後想到的詞。",
    "我說分散風險，買了六個。其中一個漲了。另外五個把它漲的吃掉了。",
    "我說不在乎短期波動。它跌8%的那個晚上，我睡不著。",
    "我每次虧錢都說要檢討。我現在虧法非常多元。",
    "主力拉高出貨。我以為是突破。我進去幫他出貨了。謝謝光臨。",
    "它跌停我還在想要不要賣。這個問題已經沒有意義了。",
    "你問我為什麼跌。因為你買了。就這樣。",
    "攤平的原理：小虧加大注，變成大虧。非常穩定。",
    "「底部」這個詞，我已經用過十幾次了。每次都繼續跌。",
    "我說做空穩穩賺。它一直漲。我的穩穩賺變成穩穩還。",
    "好消息出來要賣。我知道。我做不到。",
    // ── 對話 ──
    "「你怎麼知道會跌？」\n「我買了。」",
    "「今天賺了嗎？」\n「沒有。」\n「昨天？」\n「也沒有。」\n「你為什麼還在做？」\n「手續費不能退。」",
