...
(function initPeekBear() {
  ...
  const LINES = [
    // ── 博恩風格 ──
    "我媽問我投資賺了多少。我說媽你別管這個。她說你賠了多少。我說媽我愛你。",
    "我設了止損。但我告訴自己，等它反彈就好。它沒有反彈。它去了一個更好的地方。",
    "群組老師說這個一定漲。我問他怎麼那麼確定。他說他感覺。我花三萬塊買了一個感覺。",
    "我爸說年輕人要學理財。我學了。我現在非常理解什麼叫做「沒財」。",
    "我看了一百部交易教學影片。我終於學會一件事：這些人是靠賣課賺錢的。",
    "我問 AI 今天能不能買。它說它只是語言模型。我說那你猜猜。它說可以買。我們都錯了。",
    "我的交易策略是：跌了買，漲了賣。我完美買在每個高點，賣在每個低點。這需要天分的。",
    "他們說做空風險無限。我做多，風險有限——限於我的全部資產。",
    "我說我在做價值投資。意思是它跌了，但我相信它的價值。它繼續跌。我繼續相信。",
    "有人問我投資心法。我說順勢而為。他問哪個勢。我說，就是讓你虧錢的那個。",
    "我每次做錯都說下次一定改。我改了。改成用更大的倉位做同樣的錯誤。",
    "他們說市場永遠是對的。那我每次虧錢，是我對還是市場對？這個問題我想了很久。帳戶先歸零了。",
    // ── Jim 陳建平風格 ──
    "你看，它跌破支撐了，你還不跑。你在等什麼？等它跌到你滿意為止嗎？",
    "你說你是存股。不是，你是套牢，說自己在存股。",
    "法人昨天買超，今天賣超。你昨天跟法人買了。你現在知道你是誰了嗎？",
    "消息說要漲。消息都出來了，主力早跑了。你是來送錢的。",
    "量能萎縮，代表沒人要買。你還進去買，那你就是那個沒人。",
    "你看這根K線，標準墓碑線。你還加碼。你是去祭拜的嗎？",
    "追漲殺跌是人性。克服人性才能賺錢。所以賺錢的人，都不太算人。",
    "技術面破底，你說基本面還好。那你買基本面啊。但你是看技術面進來的，你忘了嗎？",
    "主力洗盤就是這樣，把你的信心洗掉，再把你的籌碼收走。洗得很乾淨。",
    "你問我這支還會不會跌。我說我不知道。你說那你分析什麼。我說我分析給你看它為什麼跌到這裡，不是分析它要跌到哪裡，你去問它。",
  ];
  let _lineIdx = 0;
