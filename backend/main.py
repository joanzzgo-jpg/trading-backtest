...
def _build_js_bundle():
    ...
    try:
        ...
        js = js.resolve()
        names = ["config","utils","charts","draw","colors","ticker","winrate","render","realtime","replay","ui","ai_research","signal_info","account","notify","trade","chartorder","backtest","xiaoa","lunar","main"]
