...
def _build_js_bundle():
    ...
    try:
        ...
        names = ["config","utils","charts","colors","ticker","winrate","footprint","orderbook","render","realtime","replay","ui","ai_research","signal_info","account","notify","chartorder","xiaoa","lunar","announce","multichart","main"]
