...
#   ⚠ 上限 1500（Binance klines 單次；粗K一通抓完）。加深＝細K填充跨更多背景輪（budget 22/輪不動，
#   別為了快而調大 budget→曾把全站權重打爆）。首屏先給粗K近似(x=false)、精確逐輪覆蓋。
_HIST_CAP = {"1m": 600, "5m": 1000, "15m": 1000, "30m": 1000, "1h": 900, "4h": 900, "1d": 1000}
